              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                  <h2 className="text-3xl font-bold text-white sm:text-4xl">
                    Everything you need to manage clips
                  </h2>
                  <p className="mt-4 text-slate-400 max-w-2xl mx-auto">
                    Built for developers, designers, and writers who copy-paste
                    100 times a day.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  {FEATURES.map((f, i) => (
                    <div
                      key={i}
                      className={`p-6 rounded-2xl bg-slate-800/50 border border-slate-700 hover:border-primary/50 transition-all duration-700 hover:-translate-y-1 ${
                        featuresVisible
                          ? "opacity-100 translate-y-0"
                          : "opacity-0 translate-y-10"
                      }`}
                    ...
                    >
                      <div
                        className={`w-12 h-12 rounded-lg ${f.color} bg-opacity-20 flex items-center justify-center mb-4`}
                      >
                        <f.icon
                          className={`w-6 h-6 ${f.color.replace(
                            "bg-",
                            "text-"
                          )}`}
                        />
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            <div
              className={`col-span-2 md:col-span-1 transition-all duration-700 delay-0 ${
                footerVisible
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-10"
              }`}
          ...
          <div
            className={`border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 transition-all duration-700 delay-500 ${
              footerVisible
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-10"
            }`}
